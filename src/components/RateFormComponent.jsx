    ...
    <ScrollView style={styles.container}>
      <View>
        <View style={{ paddingBottom: SIZES.padding * 2 }}>
          ...
          <Text style={{ ...FONTS.body1, fontWeight: '100', lineHeight: 25, paddingBottom: SIZES.padding * 0.5, color:'#1c53b3' }}>
            Before you proceed, we recommend reviewing our Data Collection and Privacy Policy to understand how we handle your information. Click here.  
        </Text>
         </TouchableOpacity>
         <Text style={{ ...FONTS.h3, fontWeight: '700', lineHeight: 25, paddingBottom: SIZES.padding * 0.5 }}>Ready to begin?</Text>
          <Text style={{ ...FONTS.body1, fontWeight: '100', lineHeight: 25, paddingBottom: SIZES.padding * 0.5 }}>
          ...
          <Text style={{ ...FONTS.body1, fontWeight: '100', lineHeight: 25, paddingBottom: SIZES.padding * 0.5 }}>
            Here you will find a subset of questions that CSRFi/IRL have developed to assist
              ...
              case 'radio':
                return (
                  <View style={styles.inputContainer} key={index}>
                    ...
                    <RadioButton.Group style={{ height: 30, width: 30 }} onValueChange={(newValue) => handleChange(field.label, newValue)} value={field.value}>
